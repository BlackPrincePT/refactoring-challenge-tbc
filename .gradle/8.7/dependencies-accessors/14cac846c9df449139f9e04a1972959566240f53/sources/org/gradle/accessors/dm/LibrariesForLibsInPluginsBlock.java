...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>datastorePreferences</b> with value <b>1.1.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>moshi</b> with value <b>1.15.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class NavigationPluginAccessors extends PluginFactory {
        private final NavigationSafeargsPluginAccessors paccForNavigationSafeargsPluginAccessors = new NavigationSafeargsPluginAccessors(providers, config);

        public NavigationPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of plugins at <b>plugins.navigation.safeargs</b>
         */
        public NavigationSafeargsPluginAccessors getSafeargs() {
            return paccForNavigationSafeargsPluginAccessors;
        }

    }

    public static class NavigationSafeargsPluginAccessors extends PluginFactory {

        public NavigationSafeargsPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>navigation.safeargs.kotlin</b> with plugin id <b>androidx.navigation.safeargs.kotlin</b> and
         * with version reference <b>navigationFragment</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getKotlin() { return createPlugin("navigation.safeargs.kotlin"); }
